...
(function(domGlobals) {
    ...
    var processEvent = function(eventName, initialTarget, f) {
        var status = readOptFrom$1(eventConfig.get(), eventName)
            .orThunk(function() {
            ...
            return derive(
                onFocusHandler.toArray().concat([
                    ...
                    run(keyup(), function(component, simulatedEvent) {
                        processKey(component, simulatedEvent, getKeyupRules, keyingConfig, keyingState).each(function(
                            _
                        ) {
                            simulatedEvent.stop();
                        });
    ...
    var combineGroups = function(byEventName, eventOrder) {
        var r = mapToArray(byEventName, function(tuples, eventName) {
            var combined =
                tuples.length === 1 ? Result.value(tuples[0].handler()) : fuse$1(tuples, eventOrder, eventName);
    ...
    var detect$4 = function(settings, features) {
        ...
        return bind(itemNames, function(iName) {
            var r =
                !hasKey$1(present, iName) && hasKey$1(features, iName) && features[iName].isSupported()
                ...
                Container.sketch({
                    ...
                    components: [
                        Button.sketch({
                            ...
                            buttonBehaviours: derive$1([
                                Toggling.config({ toggleClass: Styles.resolve('mask-tap-icon-selected') })
                            ])
                        })
                    ]
                })
                ...
                tgroupBehaviours: derive$1([
                    config(
                        ...
                        gSpec.scrollable === true
                            ? [
                                  runOnInit(function(component, simulatedEvent) {
    ...
    var setup$2 = function(container, rawSettings) {
        ...
        var pointerEvents = PlatformDetection$1.detect().deviceType.isTouch()
            ...
            : ['mousedown', 'mouseup', 'mouseover', 'mousemove', 'mouseout', 'click'];
    ...
    var renderMobileTheme = function(editor) {
        var renderUI = function() {
            ...
            var realm = PlatformDetection$1.detect().os.isAndroid()
