...
!(function() {
    ...
    var e = function(t) {
        ...
        i = function(t, n) {
            t.fire('VisualBlocks', { state: n });
        },
        u = function(t, n, o) {
            t.dom.toggleClass(t.getBody(), 'mce-visualblocks'), o.set(!o.get()), i(t, o.get());
        },
        c = function(t, n, o) {
        ...
        r = function(n, t, o) {
            n.on('PreviewFormats AfterPreviewFormats', function(t) {
                o.get() && n.dom.toggleClass(n.getBody(), 'mce-visualblocks', 'afterpreviewformats' === t.type);
            }),
                n.on('init', function() {
                    s(n) && u(n, t, o);
                }),
                n.on('remove', function() {
                    n.dom.removeClass(n.getBody(), 'mce-visualblocks');
                });
        },
        o = function(o, e) {
            return function(n) {
