...
!(function(r) {
    ...
    var o = function(t) {
        ...
        s = function(t) {
            ...
            return (e = (e = (e = (e = e.replace(/\{path\}/g, r.document.location.pathname)).replace(
                /\{query\}/g,
                r.document.location.search
            )).replace(/\{hash\}/g, r.document.location.hash)).replace(/\{id\}/g, t.id));
        },
        c = function(t, e) {
            var r = t.settings.forced_root_block;
            return (
                '' === (e = i.trim(void 0 === e ? t.getBody().innerHTML : e)) ||
                new RegExp('^<' + r + '[^>]*>((\xa0|&nbsp;|[ \t]|<br[^>]*>)+?|)</' + r + '>|<br>$', 'i').test(e)
            );
        },
        f = function(t) {
            var e = parseInt(a.getItem(s(t) + 'time'), 10) || 0;
            return !(new Date().getTime() - e > u(t.settings.autosave_retention, '20m')) || (l(t, !1), !1);
        },
        l = function(t, e) {
            var r = s(t);
            a.removeItem(r + 'draft'), a.removeItem(r + 'time'), !1 !== e && t.fire('RemoveDraft');
        },
        m = function(t) {
            var e = s(t);
            !c(t) &&
        ...
        v = function(t) {
            var e = s(t);
            f(t) && (t.setContent(a.getItem(e + 'draft'), { format: 'raw' }), t.fire('RestoreDraft'));
        },
        d = function(t, e) {
            var r = u(t.settings.autosave_interval, '30s');
            e.get() ||
    ...
    var p = tinymce.util.Tools.resolve('tinymce.EditorManager'),
        D = function(r, t) {
            return function(t) {
                t.setDisabled(!f(r));
                var e = function() {
