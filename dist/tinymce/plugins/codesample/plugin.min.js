...
!(function(c) {
    ...
    var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        g =
            void 0 !== t
                ? t
                : 'undefined' != typeof WorkerGlobalScope && c.self instanceof WorkerGlobalScope
                ? c.self
                : {},
        i = (function() {
            var u = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
                S = (g.Prism = {
                    util: {
                        encode: function(e) {
                            return e instanceof s
                                ? new s(e.type, S.util.encode(e.content), e.alias)
                                : 'Array' === S.util.type(e)
                                ? e.map(S.util.encode)
                                : e
                                      .replace(/&/g, '&amp;')
                        ...
                        clone: function(e) {
                            switch (S.util.type(e)) {
                                case 'Object':
                                    var t = {};
                                    for (var n in e) e.hasOwnProperty(n) && (t[n] = S.util.clone(e[n]));
                                    return t;
                                case 'Array':
                                    return (
                                        e.map &&
                    ...
                    languages: {
                        ...
                        insertBefore: function(n, e, t, a) {
                            ...
                            for (var s in r)
                                if (r.hasOwnProperty(s)) {
                                    if (s === e) for (var i in t) t.hasOwnProperty(i) && (o[i] = t[i]);
                                    o[s] = r[s];
                                }
                            return (
                        ...
                        DFS: function(e, t, n) {
                            for (var a in e)
                                e.hasOwnProperty(a) &&
                                    (t.call(e, a, e[a], n || a),
                                    'Object' === S.util.type(e[a])
                                        ? S.languages.DFS(e[a], t)
                                        : 'Array' === S.util.type(e[a]) && S.languages.DFS(e[a], t, a));
                        }
                    },
                    plugins: {},
                    highlightAll: function(e, t) {
                        for (
                            var n = c.document.querySelectorAll(
                            ...
                            S.highlightElement(r, !0 === e, t);
                    },
                    highlightElement: function(e, t, n) {
                        for (var a, r, i = e; i && !u.test(i.className); ) i = i.parentNode;
                        i && ((a = (i.className.match(u) || [, ''])[1]), (r = S.languages[a])),
                            (e.className = e.className.replace(u, '').replace(/\s+/g, ' ') + ' language-' + a),
                            (i = e.parentNode),
                            /pre/i.test(i.nodeName) &&
                                (i.className = i.className.replace(u, '').replace(/\s+/g, ' ') + ' language-' + a);
                        var o = e.textContent,
                            s = { element: e, language: a, grammar: r, code: o };
                        if (o && r)
                            if ((S.hooks.run('before-highlight', s), t && g.Worker)) {
                                var l = new c.Worker(S.filename);
                                ...
                                (s.highlightedCode = S.highlight(s.code, s.grammar, s.language)),
                                    S.hooks.run('before-insert', s),
                                    (s.element.innerHTML = s.highlightedCode),
                                    n && n.call(e),
                                    S.hooks.run('after-highlight', s),
                                    S.hooks.run('complete', s);
                        else S.hooks.run('complete', s);
                    },
                    highlight: function(e, t, n) {
                        var a = S.tokenize(e, t);
                        return s.stringify(S.util.encode(a), n);
                    },
                                        ...
                                        if (!(h instanceof a)) {
                                            ...
                                            if (m) {
                                                ...
                                                var b = m.index - 1 + d,
                                                    ...
                                                    w = [f, 1];
                                                v && w.push(v);
                                                var x = new a(o, c ? S.tokenize(m, c) : m, p);
                                                w.push(x), k && w.push(k), Array.prototype.splice.apply(r, w);
                                            }
                                        }
                                    }
                                }
                    ...
                    hooks: {
                        ...
                        run: function(e, t) {
                            var n = S.hooks.all[e];
                            if (n && n.length) for (var a = 0, r = void 0; (r = n[a++]); ) r(t);
                        }
                    }
                }),
                s = (S.Token = function(e, t, n) {
                    (this.type = e), (this.content = t), (this.alias = n);
                });
            if (
                ((s.stringify = function(t, n, e) {
                    ...
                    if (('comment' === a.type && (a.attributes.spellcheck = 'true'), t.alias)) {
                        var r = 'Array' === S.util.type(t.alias) ? t.alias : [t.alias];
                        Array.prototype.push.apply(a.classes, r);
                    }
                    S.hooks.run('wrap', a);
                    var i = '';
                    for (var o in a.attributes) i += (i ? ' ' : '') + o + '="' + (a.attributes[o] || '') + '"';
                    return (
                        '<' + a.tag + ' class="' + a.classes.join(' ') + '" ' + i + '>' + a.content + '</' + a.tag + '>'
                    );
                }),
                !g.document)
            )
                        ...
                        g.addEventListener(
                            ...
                            function(e) {
                                var t = JSON.parse(e.data),
                                    ...
                                    a = t.code,
                                    r = t.immediateClose;
                                g.postMessage(S.highlight(a, S.languages[n], n)), r && g.close();
                            },
                            !1
                        ),
                    g.Prism
    ...
    void 0 !== n && (n.Prism = i),
        ...
        i.languages.markup &&
            (i.languages.insertBefore('markup', 'tag', {
                style: {
                    ...
                    inside: {
                        tag: { pattern: /<style[\w\W]*?>|<\/style>/i, inside: i.languages.markup.tag.inside },
        ...
        i.languages.insertBefore('javascript', 'class-name', {
            'template-string': {
                pattern: /`(?:\\`|\\?[^`])*`/,
                inside: {
                    interpolation: {
        ...
        i.languages.markup &&
            i.languages.insertBefore('markup', 'tag', {
                script: {
                    ...
                    inside: {
                        tag: { pattern: /<script[\w\W]*?>|<\/script>/i, inside: i.languages.markup.tag.inside },
                        rest: i.languages.javascript
                    },
        ...
        delete i.languages.c['class-name'],
        ...
        i.languages.insertBefore('csharp', 'keyword', { preprocessor: { pattern: /(^\s*)#.*/m, lookbehind: !0 } }),
        ...
        i.languages.markup &&
            (i.hooks.add('before-highlight', function(t) {
                'php' === t.language &&
                    ((t.tokenStack = []),
                    (t.backupCode = t.code),
            ...
            i.hooks.add('before-insert', function(e) {
                'php' === e.language && ((e.code = e.backupCode), delete e.backupCode);
            }),
            i.hooks.add('after-highlight', function(e) {
                if ('php' === e.language) {
                    for (var t = 0, n = void 0; (n = e.tokenStack[t]); t++)
                        e.highlightedCode = e.highlightedCode.replace(
                            '{{{PHP' + (t + 1) + '}}}',
                            i.highlight(n, e.grammar, 'php').replace(/\$/g, '$$$$')
                        );
            ...
            i.languages.insertBefore('php', 'comment', {
                markup: { pattern: /<[^?]\/?(.*?)>/, inside: i.languages.markup },
                php: /\{\{\{PHP[0-9]+\}\}\}/
            })),
        (i.languages.python = {
    ...
    var a,
        ...
        w = {
            ...
            none: y,
            from: function(e) {
                return null === e || e === undefined ? v : k(e);
            }
        },
        x = function(e) {
            var t = e.selection ? e.selection.getNode() : null;
            return d.isCodeSample(t) ? w.some(t) : w.none();
        },
        S = x,
        A = function(t, n, a) {
            t.undoManager.transact(function() {
                ...
                return (
                    ...
                    e.fold(
                        function() {
                            t.insertContent('<pre id="__new" class="language-' + n + '">' + a + '</pre>'),
                                t.selection.select(t.$('#__new').removeAttr('id')[0]);
                        },
                        function(e) {
                            t.dom.setAttrib(e, 'class', 'language-' + n),
                                (e.innerHTML = a),
        ...
        O = function(e, n) {
            return S(e).fold(
                ...
                function(e) {
                    var t = e.className.match(/language-(\w+)/);
                    return t ? t[1] : n;
                }
            );
        },
        ...
        W =
            ...
            function(n) {
                var e,
                    t = N(n),
                    a = ((e = t), 0 === e.length ? w.none() : w.some(e[0])).fold(
                        function() {
                            return '';
                        },
                        function(e) {
                ...
                n.windowManager.open({
                    ...
                    body: {
                        type: 'panel',
                        items: [
                            { type: 'selectbox', name: 'language', label: 'Language', items: t },
        ...
        j = function(t) {
            t.addCommand('codesample', function() {
                ...
                t.selection.isCollapsed() || d.isCodeSample(e) ? W(t) : t.formatter.toggle('code');
            });
        },
        T = function(n) {
            var r = n.$;
            n.on('PreProcess', function(e) {
                r('pre[contenteditable=false]', e.node)
                    ...
                    .each(function(e, t) {
                        var n = r(t),
                            a = t.textContent;
                        n.attr('class', r.trim(n.attr('class'))),
                        ...
                        n.undoManager.transact(function() {
                            e.each(function(e, t) {
                                r(t)
                                    .find('br')
                                    .each(function(e, t) {
                                        t.parentNode.replaceChild(n.getDoc().createTextNode('\n'), t);
                                    }),
                                    (t.contentEditable = 'false'),
                                    (t.innerHTML = n.dom.encode(t.textContent)),
                                    i.highlightElement(t),
                                    (t.className = r.trim(t.className));
                            });
                        });
                });
        },
        B = function(a) {
            a.ui.registry.addToggleButton('codesample', {
                ...
                onSetup: function(n) {
                    var e = function() {
                        var e, t;
                        n.setActive(((t = (e = a).selection.getStart()), e.dom.is(t, 'pre.language-markup')));
                    };
                    return (
                        a.on('NodeChange', e),
                        function() {
    ...
    !(function $() {
        e.add('codesample', function(t) {
            T(t),
                B(t),
                j(t),
                t.on('dblclick', function(e) {
                    d.isCodeSample(e.target) && W(t);
                });
        });
    })();
})(window);
