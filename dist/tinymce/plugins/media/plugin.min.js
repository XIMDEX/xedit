...
!(function() {
    ...
    var e,
        ...
        p = d,
        g = function(e) {
            return null === e || e === undefined ? f : h(e);
        },
        v = function(t) {
            return function(e) {
                return (
        ...
        _ =
            ...
            function() {
                ...
                for (var r = {}, n = 0; n < e.length; n++) {
                    var i = e[n];
                    for (var o in i) S.call(i, o) && (r[o] = a(r[o], i[o]));
                }
                return r;
            }),
        C = Object.hasOwnProperty,
        M = function(e, t) {
            return F(e, t) ? g(e[t]) : p();
        },
        F = function(e, t) {
            return C.call(e, t);
        },
        ...
        L = tinymce.util.Tools.resolve('tinymce.html.SaxParser'),
        ...
        q = {
            ...
            setMaxWidth: I('maxWidth'),
            setMaxHeight: I('maxHeight')
        },
        B = function(e, t) {
        ...
        G = W.DOM,
        J = function(e) {
            return G.getAttrib(e, 'data-ephox-embed-iri');
        },
        K = function(e, t) {
            return (
                (c = t),
                (u = G.createFragment(c)),
                '' !== J(u.firstChild)
                    ? ((o = t),
                      (a = G.createFragment(o).firstChild),
                      {
                          type: 'ephox-embed-iri',
                          source1: J(a),
                          source2: '',
                          poster: '',
                          width: q.getMaxWidth(a),
                          height: q.getMaxHeight(a)
                      })
                    : ((n = e),
                      (r = t),
                      L({
                          ...
                          start: function(e, t) {
                              if (
                                  (i.source1 || 'param' !== e || (i.source1 = t.map.movie),
                                  ('iframe' !== e &&
                                      'object' !== e &&
                                      'embed' !== e &&
                                      'video' !== e &&
                                      'audio' !== e) ||
                                      (i.type || (i.type = e), (i = R.extend(t.map, i))),
                                  'script' === e)
                              ) {
                                  var r = B(n, t.map.src);
                                  if (!r) return;
                              ...
                              'source' === e &&
                                  (i.source1 ? i.source2 || (i.source2 = t.map.src) : (i.source1 = t.map.src)),
                                  'img' !== e || i.poster || (i.poster = t.map.src);
                          }
                      }).parse(r),
        ...
        X = tinymce.util.Tools.resolve('tinymce.html.Writer'),
        ...
        ee = function(e, t) {
            ...
            for (r in t)
                if (((i = '' + t[r]), e.map[r]))
                    for (n = e.length; n--; )
                        (o = e[n]).name === r &&
                            (i ? ((e.map[r] = i), (o.value = i)) : (delete e.map[r], e.splice(n, 1)));
                else i && (e.push({ name: r, value: i }), (e.map[r] = i));
        },
        te = function(e, t) {
            var r,
                n,
                i = Z.createFragment(e).firstChild;
            return (
                q.setMaxWidth(i, t.width),
                q.setMaxHeight(i, t.height),
                (r = i.outerHTML),
                (n = X()),
                L(n).parse(r),
                n.getContent()
        ...
        re = function(e, t, r) {
            return (
                (s = e),
                (l = Z.createFragment(s)),
                '' !== Z.getAttrib(l.firstChild, 'data-ephox-embed-iri')
                    ? te(e, t)
                    : ((n = e),
                      (i = t),
                      (o = r),
                      ...
                      L(
                          {
                              validate: !1,
                              allow_conditional_comments: !(u = 0),
                              comment: function(e) {
                                  c.comment(e);
                              },
                              cdata: function(e) {
                              ...
                              start: function(e, t, r) {
                                  switch (e) {
                                      ...
                                      case 'iframe':
                                          i.height !== undefined &&
                                              i.width !== undefined &&
                                              ee(t, { width: i.width, height: i.height });
                                  }
                                  if (o)
                                      switch (e) {
                                          case 'video':
                                              ee(t, { poster: i.poster, src: '' }), i.source2 && ee(t, { src: '' });
                                              break;
                                          case 'iframe':
                                              ee(t, { src: i.source1 });
                                              break;
                                          case 'source':
                                              if (
                                                  ++u <= 2 &&
                                                  (ee(t, { src: i['source' + u], type: i['source' + u + 'mime'] }),
                                                  !i['source' + u])
                                              )
                                                  return;
                                              break;
                                  ...
                                  if ('video' === e && o)
                                      for (var t = 1; t <= 2; t++)
                                          if (i['source' + t]) {
                                              ...
                                              (r.map = {}),
                                                  u < t &&
                                                      (ee(r, { src: i['source' + t], type: i['source' + t + 'mime'] }),
                                                      c.start('source', r, !0));
                                          }
                                  if (i.poster && 'object' === e && o && !a) {
                                      var n = [];
                                      (n.map = {}),
                                          ee(n, { src: i.poster, width: i.width, height: i.height }),
                                          c.start('img', n, !0);
                                  }
                                  c.end(e);
                              }
        ...
        ie = function(r, e) {
            var n = R.extend({}, e);
            if (!n.source1 && (R.extend(n, K(P(r), n.embed)), !n.source1)) return '';
            n.source2 || (n.source2 = ''),
                n.poster || (n.poster = ''),
                (n.source1 = r.convertURL(n.source1, 'source')),
                (n.source2 = r.convertURL(n.source2, 'source')),
                (n.source1mime = V(n.source1)),
                (n.source2mime = V(n.source2)),
            ...
            if (
                ...
                return re(n.embed, n, !0);
            var a = B(P(r), n.source1);
            a && ((n.type = 'script'), (n.width = String(a.width)), (n.height = String(a.height)));
            var c,
                u,
                s,
                l,
            ...
            return (
                ...
                'iframe' === n.type
                    ? ((h = (f = n).allowFullscreen ? ' allowFullscreen="1"' : ''),
                      '<iframe src="' +
                          f.source1 +
                          '" width="' +
                          f.width +
                    ...
                    ? ((d =
                      ...
                      m.poster &&
                          (d += '<img src="' + m.poster + '" width="' + m.width + '" height="' + m.height + '" />'),
                      (d += '</object>'))
        ...
        ce = function(e, t) {
            ...
            return c
                ? ((i = t),
                  ...
                  new Q(function(t, e) {
                      var r = function(e) {
                          return e.html && (oe[i.source1] = e), t({ url: i.source1, html: e.html ? e.html : o(i) });
                      };
                      oe[i.source1] ? r(oe[i.source1]) : a({ url: i.source1 }, r, e);
                  }))
                : ((r = t),
                  (n = ae(e)),
                  new Q(function(e) {
        ...
        se = function(e) {
            ...
            return (
                M(e, 'dimensions').each(function(e) {
                    j(['width', 'height'], function(t) {
                        M(e, t).each(function(e) {
                            return (r[t] = e);
                        });
                    });
                }),
        ...
        le = function(e) {
            var n = _(e, {
                source1: { value: M(e, 'source1').getOr('') },
                source2: { value: M(e, 'source2').getOr('') },
                poster: { value: M(e, 'poster').getOr('') }
            });
            return (
                j(['width', 'height'], function(r) {
                    M(e, r).each(function(e) {
                        var t = n.dimensions || {};
        ...
        fe = function(i, o) {
            return function(e) {
                if (w(e.url) && 0 < e.url.trim().length) {
                    var t = e.html,
                        r = de(o, t),
                        n = c({}, r, { source1: e.url, embed: t });
                    i.setData(le(n));
                }
            };
        },
        ...
        pe = function(c) {
            var e,
                ...
                a = {
                    ...
                    items: (function(e) {
                        for (var t = [], r = 0, n = e.length; r < n; ++r) {
                            if (!b(e[r])) throw new Error('Arr.flatten item ' + r + ' was not an array, input: ' + e);
                            O.apply(t, e[r]);
                        }
                        return t;
                    })([
                        [{ name: 'source1', type: 'urlinput', filetype: 'media', label: 'Source' }],
                        U(c)
                ...
                m = [];
            E(c) && m.push({ name: 'source2', type: 'urlinput', filetype: 'media', label: 'Alternative source URL' }),
                N(c) &&
                    m.push({ name: 'poster', type: 'urlinput', filetype: 'image', label: 'Media poster (Image URL)' });
            var d = { title: 'Advanced', name: 'advanced', items: m },
                f = [a, l];
            0 < m.length && f.push(d);
            var h = { type: 'tabpanel', tabs: f },
                p = c.windowManager.open({
                    ...
                    onSubmit: function(e) {
                        ...
                        (t = u.get()),
                            (n = c),
                            ((r = i).embed = re(r.embed, r)),
                            r.embed && (t.source1 === r.source1 || ue(r.source1))
                                ? he(n, r.embed)
                                : ce(n, r)
                                      .then(function(e) {
                                          he(n, e.html);
                        ...
                        switch (t.name) {
                            case 'source1':
                                (o = u.get()),
                                    (a = s(e)),
                                    o.source1 !== a.source1 &&
                                        (fe(p, c)({ url: a.source1, html: '' }),
                                        ce(c, a)
                                            .then(fe(p, c))
                                            ['catch'](me(c)));
                                break;
                            case 'embed':
                                (n = se((r = e).getData())), (i = de(c, n.embed)), r.setData(le(i));
                        }
                        var r, n, i, o, a;
                        u.set(s(e));
                    },
        ...
        we = tinymce.util.Tools.resolve('tinymce.html.Node'),
                        ...
                        start: function(e, t, r) {
                            if (((o = !0), 'script' !== e && 'noscript' !== e)) {
                                for (var n = 0; n < t.length; n++) {
                                    ...
                                    'style' === t[n].name &&
                                        (t[n].value = i.dom.serializeStyle(i.dom.parseStyle(t[n].value), e));
                                }
                                a.start(e, t, r), (o = !1);
                            }
                        },
        ...
        je = function(e, t) {
            ...
            return (
                ...
                (i = new we('span', 1)).attr('class', 'mce-shim'),
                r.append(n),
                r.append(i),
                r
            );
        ...
        Oe = function(e, t, r) {
            ...
            (c = t.firstChild && t.firstChild.value) &&
                (r.attr('data-mce-html', escape(ye(e, c))), (r.firstChild = null));
        },
        Ae = function(e) {
            for (; (e = e.parent); )
                ...
                for (var t, r, n = e.length; n--; )
                    (t = e[n]).parent &&
                        (t.parent.attr('data-mce-object') ||
                            (('script' !== t.name || (r = B(P(i), t.attr('src')))) &&
                                (r &&
                                    (r.width && t.attr('width', r.width.toString()),
                                    r.height && t.attr('height', r.height.toString())),
                                'iframe' === t.name && $(i) && be.ceFalse
                                    ? Ae(t) || t.replace(je(i, t))
                                    : Ae(t) || t.replace(xe(i, t)))));
            };
        },
        _e = function(d) {
            d.on('preInit', function() {
                ...
                R.each('webkitallowfullscreen mozallowfullscreen allowfullscreen'.split(' '), function(e) {
                    r[e] = {};
                }),
                    d.parser.addNodeFilter('iframe,video,audio,object,embed,script', Se(d)),
                            ...
                            if ((r = e[l]).parent) {
                                ...
                                'script' === u && n.attr('type', 'text/javascript'),
                                    (a = r.attr('data-mce-html')) &&
                                        (((c = new we('#text', 3)).raw = !0),
                                        (c.value = ye(d, unescape(a))),
                                        n.append(c)),
                                    r.replace(n);
                            }
                    });
            ...
            t.on('click keyup', function() {
                ...
                t.on('ObjectResized', function(e) {
                    ...
                    r.getAttribute('data-mce-object') &&
                        ...
                        r.setAttribute(
                            'data-mce-html',
                            escape(re(t, { width: String(e.width), height: String(e.height) }))
                        ));
                });
        },
        Fe = function(e) {
    ...
    !(function Pe() {
        i.add('media', function(e) {
            return ve(e), Fe(e), Ce(e), _e(e), Me(e), ge(e);
        });
    })();
})();
