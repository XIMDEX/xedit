...
!(function() {
    ...
    var r = function(e) {
        ...
        s = function(e, t) {
            e.ui.registry.addButton('help', { icon: 'help', tooltip: 'Help', onAction: t }),
                e.ui.registry.addMenuItem('help', { text: 'Help', icon: 'help', shortcut: 'Alt+0', onAction: t });
        },
        l = function() {
            return (l =
                Object.assign ||
    ...
    var n,
        ...
        v = {
            ...
            none: y,
            from: function(e) {
                return null === e || e === undefined ? b : k(e);
            }
        },
        w =
            ((u = 'function'),
        ...
        C =
            (h = Array.prototype.indexOf) === undefined
                ? function(e, t) {
                      return P(e, t);
                  }
                : function(e, t) {
        ...
        M = (w(Array.from) && Array.from, Object.keys),
        ...
        I = function(e) {
            ...
            return E.mac ? o.join('').replace(/\s/, '') : o.join('+');
        },
        _ = function() {
            return {
                name: 'shortcuts',
                ...
                items: [
                    {
                        ...
                        cells: x(S, function(e) {
                            var t = x(e.shortcuts, I).join(' or ');
                            return [e.action, t];
                        })
                    }
                ]
        ...
        j = function(e, a) {
            return e.replace(/\$\{([^{}]*)\}/g, function(e, t) {
                var n,
                    o = a[t];
                return 'string' === (n = typeof o) || 'number' === n ? o.toString() : e;
            });
        },
        ...
        W = function(e) {
            var t,
                n,
                o = p(j, '<a href="${url}" target="_blank" rel="noopener">${name}</a>'),
                a = function(t, n) {
                    return (function(e, t) {
                        for (var n = 0, o = e.length; n < o; n++) {
                            var a = e[n];
                            if (t(a, n, e)) return v.some(a);
                        }
                        return v.none();
                    })(U, function(e) {
                        return e.key === n;
                        ...
                        function(e) {
                            return o({ name: e.name, url: 'https://www.tiny.cloud/docs/plugins/' + e.key });
                        }
                    );
                };
            return {
                        ...
                        html: [
                            ...
                            null == n
                                ...
                                : '<div data-mce-tabstop="1" tabindex="-1">' +
                                  ...
                                  (c = M((i = r).plugins)),
                                  (l =
                                      i.settings.forced_plugins === undefined
                                          ? c
                                          : (function(e, t) {
                                                ...
                                                c,
                                                ((s = p(T, i.settings.forced_plugins)),
                                                function() {
        ...
        D = tinymce.util.Tools.resolve('tinymce.EditorManager'),
        N = function() {
            var e,
                t,
                n =
                    ...
                    ((e = D.majorVersion), (t = D.minorVersion), 0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) +
                    '</a>';
            return {
                name: 'versions',
                title: 'Version',
                items: [
                    {
                        type: 'htmlpanel',
                        html: '<p>' + H.translate(['You are using {0}', n]) + '</p>',
                        presets: 'document'
                    }
                ]
            };
        ...
        B = function(e) {
            var t,
                n = M(e);
            return (
                (-1 === (t = C(n, 'versions')) ? v.none() : v.some(t)).each(function(e) {
                    n.splice(e, 1), n.push('versions');
                }),
                { tabs: e, names: n }
            );
        },
        z = function(e, t) {
            var n,
                ...
                i = W(e),
                s = N(),
                c = l((((n = {})[a.name] = a), (n[r.name] = r), (n[i.name] = i), (n[s.name] = s), n), t.get());
            return ((o = e), v.from(o.getParam('help_tabs'))).fold(
                function() {
                    return B(c);
                },
                function(e) {
                    return (
                        ...
                        (n = {}),
                        (o = x(e, function(e) {
                            return 'string' == typeof e ? (F(t, e) && (n[e] = t[e]), e) : (n[e.name] = e).name;
                        })),
                        { tabs: n, names: o }
                    );
                    var t, n, o;
                ...
                var e = z(a, r),
                    ...
                    n = {
                        ...
                        tabs: (function(e) {
                            ...
                            x(t, function(e) {
                                return F((t = o), (n = e)) ? v.from(t[n]) : v.none();
                                var t, n;
                            })
                        )
                    };
    ...
    !(function q() {
        e.add('help', function(e) {
            var n,
                ...
                a = V(e, t);
            return s(e, a), i(e, a), e.shortcuts.add('Alt+0', 'Open help dialog', 'mceHelp'), o;
        });
    })();
})();
