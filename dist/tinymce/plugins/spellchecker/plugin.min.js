...
!(function(t) {
    ...
    var a = function(e) {
        ...
        c = function(e) {
            return !(
                ...
                !n.get('tinymcespellchecker') ||
                ('undefined' != typeof t.window.console &&
    ...
    var r = function(a, r) {
            ...
            function t(e) {
                var t,
                    ...
                    r = s(e ? l(e) : null);
                for (t = r.length; t--; )
                    (n = r[t]).parentNode.insertBefore(n.firstChild, n), n.parentNode.removeChild(n);
                return this;
            }
            function u(e) {
                var t = s(l(e)),
                        ...
                        return (
                            i.length &&
                                (function f(e, t, n) {
                                    ...
                                    e: for (;;) {
                                        if (
                                            ((g[u.nodeName] || p[u.nodeName] || b(u)) && l++,
                                            3 === u.nodeType &&
                                                (!o && u.length + l >= c.end
                                                    ? ((o = u), (a = c.end - l))
                                                    : r && s.push(u),
        ...
        x = function(e, t, n) {
            e.dom.select('span.mce-spellchecker-word').length || k(e, t, n);
        },
        k = function(e, t, n) {
            var r = e.selection.getBookmark();
            if ((m(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get())) return t.set(!1), o(e), !0;
        },
        y = function(e) {
        ...
        w = {
            spellcheck: function(t, e, n, r, o, i) {
                k(t, n, r) ||
                    ...
                    v(
                        ...
                        function(e) {
                            t.notificationManager.open({ text: e, type: 'error' }), t.setProgressState(!1), k(t, n, r);
                        }
                    ),
                    t.focus());
            },
            checkIfFinished: x,
            addToDictionary: function(t, e, n, r, o, i, a) {
                t.setProgressState(!0),
                    v(
                        t,
                        e,
                        ...
                        i,
                        function() {
                            t.setProgressState(!1), t.dom.remove(a, !0), x(t, n, r);
                        },
                        function(e) {
            ...
            ignoreWord: function(t, e, n, r, o, i) {
                t.selection.collapse(),
                    i
                        ? N.each(t.dom.select('span.mce-spellchecker-word'), function(e) {
            ...
            findSpansByIndex: function(e, t) {
                var n,
                    r = [];
                if ((n = N.toArray(e.getBody().getElementsByTagName('span'))).length)
        ...
        E = function(n, e, r, t, o, i) {
            var a,
                c,
                s,
                l =
                    ((s = n),
                    (a = N.map(g(s).split(','), function(e) {
        ...
        C = function(h, p, m, v, x, k) {
            h.ui.registry.addContextMenu('spellchecker', {
                update: function(e) {
                    var t = e;
                    ...
                    var n,
                        ...
                        u,
                        d,
                        f = w.findSpansByIndex(h, w.getElmIndex(t));
                    if (0 < f.length) {
                        var g = h.dom.createRng();
                        return (
                            g.setStartBefore(f[0]),
                            g.setEndAfter(f[f.length - 1]),
                            ...
                            (a = x),
                            (c = k),
                            (s = t.getAttribute('data-mce-word')),
                            (l = f),
                            (u = []),
                            (d = o.get().suggestions[s]),
                            N.each(d, function(e) {
                                u.push({
                                    text: e,
                                    onAction: function() {
                                        n.insertContent(n.dom.encode(e)), n.dom.remove(l), w.checkIfFinished(n, i, a);
                                    }
                                });
                            }),
                            o.get().hasDictionarySupport &&
                                (u.push({ type: 'separator' }),
                                u.push({
                                    text: 'Add to dictionary',
                                    onAction: function() {
                                        w.addToDictionary(n, r, i, a, c, s, l);
                                    }
                                })),
                            u.push.apply(u, [
                                { type: 'separator' },
                                {
                                    text: 'Ignore',
                                    onAction: function() {
                                        w.ignoreWord(n, i, a, s, l);
                                    }
                                },
                                {
                                    text: 'Ignore all',
                                    onAction: function() {
                                        w.ignoreWord(n, i, a, s, l, !0);
                                    }
                                }
                            ]),
                            u
    ...
    !(function e() {
        n.add('spellchecker', function(e, t) {
            if (!1 === c(e)) {
                var n = a(!1),
                    r = a(s(e)),
                    o = a(null),
                    i = a(null);
                return E(e, t, n, o, r, i), C(e, t, i, n, o, r), I(e, t, n, o, i, r), T(e, n, i, o, r, t);
            }
        });
    })();
})(window);
