        ...
        f = function(e, t, n) {
            return (
                ...
                (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
                    ...
                    '%y',
                    '' + n.getYear()
                )).replace('%m', d(n.getMonth() + 1, 2))).replace('%d', d(n.getDate(), 2))).replace(
                    '%H',
                    '' + d(n.getHours(), 2)
                )).replace('%M', '' + d(n.getMinutes(), 2))).replace('%S', '' + d(n.getSeconds(), 2))).replace(
                    '%I',
                    '' + (((n.getHours() + 11) % 12) + 1)
                ...
                )).replace('%a', '' + e.translate(u[n.getDay()]))).replace('%%', '%'))
            );
        },
        p = function(e, t) {
            if (l(e)) {
        ...
        v = function(n) {
            ...
            n.ui.registry.addSplitButton('insertdatetime', {
                ...
                fetch: function(e) {
                    e(
                        M.map(t, function(e) {
                            return { type: 'choiceitem', text: g(n, e), value: e };
                        })
                    );
                },
                onAction: function() {
