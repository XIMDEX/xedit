    ...
    var i = function(e) {
        ...
        b = function(e, t) {
            var n,
                ...
                u = e.getDoc();
            if (u)
                if ((a = e).plugins.fullscreen && a.plugins.fullscreen.isFullscreen()) z(e, !0);
                else {
                    var a,
                        s = u.documentElement,
                        f = p(e);
                    i = v(e);
                    var c = C(r, s, 'margin-top', !0),
                        g = C(r, s, 'margin-bottom', !0);
                    (o = s.offsetHeight + c + g + f) < 0 && (o = 0);
                    var l = e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight;
                    o + l > v(e) && (i = o + l);
                    var m = y(e);
                    m && m < i ? ((i = m), z(e, !0)) : z(e, !1),
                        i !== t.get() &&
                            ((n = i - t.get()),
        ...
        n = {
            setup: function(t, n) {
                t.on('init', function() {
                    var e = o(t);
                    t.dom.setStyles(t.getBody(), { paddingLeft: e, paddingRight: e, 'min-height': 0 });
                }),
                    t.on('NodeChange SetContent keyup FullscreenStateChanged ResizeContent', function(e) {
                        b(t, n);
                    }),
                    u(t) &&
                        t.on('init', function() {
                            a(t, n, 20, 100, function() {
                                a(t, n, 5, 1e3);
                            });
                        });
            },
