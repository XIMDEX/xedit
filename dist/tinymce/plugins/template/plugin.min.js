...
!(function() {
    ...
    var n,
        ...
        m = tinymce.util.Tools.resolve('tinymce.util.XHR'),
        l = function(e) {
        ...
        v = function(e) {
            return e.getParam('template_cdate_format', e.translate('%Y-%m-%d'));
        },
        h = function(e) {
        ...
        O = function(e, t, n) {
            ...
            return (
                ...
                (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
                    ...
                    '%y',
                    '' + n.getYear()
                )).replace('%m', b(n.getMonth() + 1, 2))).replace('%d', b(n.getDate(), 2))).replace(
                    '%H',
                    '' + b(n.getHours(), 2)
                )).replace('%M', '' + b(n.getMinutes(), 2))).replace('%S', '' + b(n.getSeconds(), 2))).replace(
                    '%I',
                    '' + (((n.getHours() + 11) % 12) + 1)
        ...
        A = function(t, e, n) {
            var r,
                a,
                o = t.dom,
                u = t.selection.getContent();
            (n = T(n, g(t))),
                (r = o.create('div', null, n)),
                (a = o.select('.mceTmpl', r)) &&
                    0 < a.length &&
                    (r = o.create('div', null)).appendChild(a[0].cloneNode(!0)),
                p.each(o.select('*', r), function(e) {
                    S(e, l(t).replace(/\s+/g, '|')) && (e.innerHTML = O(t, v(t))),
                        S(e, s(t).replace(/\s+/g, '|')) && (e.innerHTML = O(t, h(t))),
                        S(e, f(t).replace(/\s+/g, '|')) && (e.innerHTML = u);
                }),
                M(t, r),
                t.execCommand('mceInsertContent', !1, r.innerHTML),
                t.addVisual();
        },
        w = function(e) {
            e.addCommand(
        ...
        J = {
            ...
            none: H,
            from: function(e) {
                return null === e || e === undefined ? k : I(e);
            }
        },
        L =
            ((u = 'function'),
        ...
        j = (L(Array.from) && Array.from, tinymce.util.Tools.resolve('tinymce.util.Promise')),
        ...
        E = function(e) {
            return e.replace(/["'<>&]/g, function(e) {
                return ((t = B), (n = e), F(t, n) ? J.from(t[n]) : J.none()).getOr(e);
                var t, n;
            });
        },
        R = function(l, t) {
            ...
            (function() {
                ...
                return l.notificationManager.open({ text: e, type: 'info' }), J.none();
            })().each(function(o) {
                var u = e(o),
                    c = function(e, t) {
                        return {
                    ...
                    i = function(e, t, n) {
                        var r = (function(t, e) {
                            ...
                            a = [
                                ...
                                { type: 'htmlpanel', html: '<p aria-live="polite">' + E(t.value.description) + '</p>' },
                                { label: 'Preview', type: 'iframe', name: 'preview', sandboxed: !1 }
                            ],
                            o = { template: t.text, preview: r };
                        e.unblock(), e.redial(c(a, o)), e.focus('template');
                    },
                    t = l.windowManager.open(c([], { template: '', preview: '' }));
                t.block('Loading...'),
                    f(o[0]).then(function(e) {
                        i(t, o[0], e);
                    });
            });
        },
