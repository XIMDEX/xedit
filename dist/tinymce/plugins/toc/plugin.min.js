    ...
    var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        d = function(t) {
            ...
            for (
                l +=
                    ...
                    (a = '</' + i + '>'),
                    '<' + i + ' contenteditable="true">' + s.DOM.encode(c) + a),
                    e = 0;
                e < u.length;
                e++
            ) {
                if ((((o = u[e]).element.id = o.id), (r = u[e + 1] && u[e + 1].level), d === o.level)) l += '<li>';
                else for (n = d; n < o.level; n++) l += '<ul><li>';
                if (((l += '<a href="#' + o.id + '">' + o.title + '</a>'), r !== o.level && r))
                    for (n = o.level; r < n; n--) l += '</li></ul><li>';
                else (l += '</li>'), r || (l += '</ul>');
                d = o.level;
            }
            return l;
        ...
        o = {
            ...
            insertToc: function(t) {
                var e,
                    ...
                    c = t.$('.' + i);
                (o = t),
                    !(r = c).length || 0 < o.dom.getParents(r[0], '.mce-offscreen-selection').length
                        ? t.insertContent(
                              ((n = d((e = t))),
        ...
        n = function(t) {
            ...
            t.on('PreProcess', function(t) {
                var e = n('.' + o, t.node);
                e.length &&
                    (e.removeAttr('contentEditable'), e.find('[contenteditable]').removeAttr('contentEditable'));
            }),
        ...
        r = function(n) {
            return function(t) {
                var e = function() {
                    return t.setDisabled(n.readonly || !o.hasHeaders(n));
                };
                return (
                    e(),
            ...
            t.ui.registry.addButton('toc', {
                ...
                t.ui.registry.addContextToolbar('toc', {
                    ...
                    predicate:
                        ((e = t),
                        function(t) {
                            return t && e.dom.is(t, '.' + a(e)) && e.getBody().contains(t);
                        }),
                    scope: 'node',
                    position: 'node'
                });
